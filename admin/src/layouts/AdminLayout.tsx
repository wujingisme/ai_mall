import { LogoutOutlined, ShoppingOutlined, UserAddOutlined } from '@ant-design/icons';
...
export default function AdminLayout() {
  ...
  return <Layout className="app-layout">
    <Layout.Sider breakpoint="lg" collapsedWidth="0"><div className="brand">AI Mall</div><Menu theme="dark" selectedKeys={[location.pathname.startsWith('/accounts') ? 'accounts' : 'products']} onClick={({ key }) => navigate(`/${key}`)} items={[
