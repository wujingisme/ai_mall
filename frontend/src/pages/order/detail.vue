...
<template>
  <view class="page">
    ...
    <template v-else-if="order">
      ...
      <view class="section pickup"><view class="section-title">取货信息</view><text class="pickup-name">{{ order.pickupLocationName }}</text><text class="pickup-address">{{ order.pickupLocationAddress }}</text><text class="pickup-tip">取货码只在首次下单成功时展示，订单详情不会重复返回；请到店线下付款后取货。</text></view>
    </template>
